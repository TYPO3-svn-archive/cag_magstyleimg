...
***************************************************************/
/**
 * XCLASS: 'Image thumbnails for Magazine Images CE in Web>Layout'
 *
    ...
    function tt_content_drawItem($row, $isRTE=FALSE)    {
        ...
        switch($row['CType'])   {
            ...
            case 'image':
                ...
                if ($row['CType']=='text' || $row['CType']=='textpic' || $row['CType']=='cag_magstyleimg_pi1')  {
                    if ($row['bodytext'])   {
                ...
                //$thumbs = $this->getDAMimageList($row['uid']);
                
                if ($row['CType']=='textpic' || $row['CType']=='image' || $row['CType']=='cag_magstyleimg_pi1') {
                    if ($row['image'])  {
                        $infoArr=Array();
